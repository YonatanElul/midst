...
dynamics_type = 'simple_dynamics' if simple_dynamics else 'ck_dynamics'
...
model_ckpt_path = os.path.join(
    logs_dir,
    f'JCK_{attractor_type}_'
    f'{old_m}_attractors_'
    f'{seed}_'
    f'{old_m}A_'
...
if __name__ == '__main__':
    ...
    experiment_name = f"JCK_{attractor_type}_New_" \
    ...
    model.encoder = trained_model.encoder
